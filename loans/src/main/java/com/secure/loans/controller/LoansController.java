package com.secure.loans.controller;

import com.secure.loans.constants.LoansConstants;
import com.secure.loans.dto.LoansContactInfoDto;
import com.secure.loans.dto.LoansDto;
import com.secure.loans.dto.ResponseDto;
import com.secure.loans.service.ILoansService;
...
@Tag(name = "Loans Controller", description = "REST API's related to Loans Management")
@RestController
...
public class LoansController {
    ...
    @Operation(summary = "Create Loan REST API", description = "REST API to create a new loan based on a mobile number")
    @ApiResponses({
